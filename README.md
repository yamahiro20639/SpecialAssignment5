...
| - 300  | 複数のリクエストが処理され、クライアントが選択必要な状況 |
| - 301  | ウェブサイトが恒久的に移転している状況 |
| - 302  | ウェブサイトが一時的に移動している状況 |
...
## 🔸ホームページを表示させる流れ
&emsp;パソコンの画面にホームページを表示させるまでには下記のような仕組みになっています。<br>
...
&emsp;先ほど記述しましたが、画面にホームページを表示させる際にも活用されています。<br>
